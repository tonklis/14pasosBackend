...
{
  require_once("coordinates.functions.php");
...
$salida='
	   ...
	   <p>
	    ...
	    <p>
	     ...
	     <input type="text" id="referencia" name="referencia" size="50" maxlength="50" value="Distrito Federal"/>
      </p>
	  	  <p>
	     <label for="fotografo">Fotografo</label><br/>
	      <input type="text" id="fotografo" name="fotografo" size="50" maxlength="50" value="Laura Janka"/>
      </p>
	  <p>
	   ...
	   <p>
	     <label for="foto_titulo">T&iacute;tulo</label><br/>
	      <input type="text" id="foto_titulo" name="foto_titulo" size="50" maxlength="50" value="Distrito Federal"/>
      </p>
	  <label for="foto_descripcion">Descripci&oacute;n</label><br/>
	  <textarea id="foto_descripcion" name="foto_descripcion" cols="48" rows="5">Primer Recorrido</textarea>
	   <div id="upload">
	     <p>
...
if ($c = getCoordinates($archivo)) {
    $latitud = $c[0];
    $longitud = $c[1];
}

if(is_null($latitud)){
$latitud=19.442358098941977;	
}

if(is_null($longitud)){
$longitud=-99.20345987216189;	
}
...
//$thumb="";
//$comping="";
$qry_foto="INSERT INTO fotos SET usuario_id=".$parametros["usuario_id"].", entidad_id=".$parametros["entidad_id"].", referencia='".$parametros["referencia"]."', latitud=".$latitud.", longitud=".$longitud.", fotografo='".$fotografo."', foto_titulo='".$foto_titulo."', foto_descripcion='".$foto_descripcion."' , thumbnail='".$thumb."', comping='".$comping."'";
